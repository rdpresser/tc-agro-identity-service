namespace TC.Agro.Identity.Service.Telemetry
{
    ...
    internal static class TelemetryConstants
    {
        ...
        public const string ServiceName = "tcagro-identity";
        ...
        // Service Components
        public const string IdentityComponent = "identity";
        ...
        public static void LogTelemetryConfiguration(Microsoft.Extensions.Logging.ILogger logger, IConfiguration configuration)
        {
            ...
            logger.LogInformation("User Meter: {UserMeterName}", IdentityMeterName);
